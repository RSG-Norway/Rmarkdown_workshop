...
```{r png_example, eval=TRUE, echo=FALSE, fig.cap="Nøkken som hvit hest (The Nix as a white horse).", cache=FALSE, include=TRUE, out.height="300px", out.width="350px", fig.align='center'}
...
```{r iris_ggplot, include=TRUE, cache=TRUE, eval=TRUE, echo=FALSE, fig.cap="A plot stolen from the web.", fig.align='center', warning=FALSE, message=FALSE}
